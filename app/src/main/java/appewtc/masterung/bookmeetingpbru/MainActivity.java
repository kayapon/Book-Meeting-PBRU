...
public class MainActivity extends AppCompatActivity {
    ...
    public void clickSignIn(View view){
        ...
        if (userString.equals("") || passwordString.equals("")) {
            ...
            myAlert.myDialog(this,",มีช่องว่าง","กรุณากรองทุกช่องคะ");
    ...
    private void searchUser(String userString){
        ...
        try {
            ...
            cursor.moveToFirst();
            userLoginString = new String[cursor.getColumnCount()];//จองหน่วยความจำตามคอลัม
            for (int i=0;i<cursor.getColumnCount();i++){
                userLoginString[i]=cursor.getString(i);
            }//for
            cursor.close();    //เลข 6 คือคอลัมส์ี่ 6
            ...
            MyAlert myAlert = new MyAlert();
            myAlert.myDialog(this,"ไม่มี User","ไม่มี"+ userString +"ไม่มีฐานข้อมูลของเรา");
        }
    }//searchUser
